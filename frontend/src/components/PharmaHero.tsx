...
// =========================================================================
export const PHARMA_HERO_IMAGE_PATH = "/slider-2.jpg";
...
export function PharmaHero() {
  ...
  return (
    <div ref={heroRef} className="sticky top-0 h-screen overflow-hidden bg-gradient-to-br from-teal-800 via-teal-900 to-slate-950">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="floating-shape absolute bottom-1/3 right-1/3 w-40 h-40 rounded-full bg-emerald-400/10 backdrop-blur-sm" />
