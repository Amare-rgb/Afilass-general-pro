        ...
        <main className="pt-32">
          <div className="container mx-auto px-4 py-20">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl font-semibold text-foreground">{t("departments.loading") || "Loading Departments..."}</h2>
              <p className="text-foreground/70">{t("departments.loading_message") || "Please wait while we fetch the departments"}</p>
            </div>
          </div>
        </main>
      </div>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-32">
          <div className="container mx-auto px-4 py-20 text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">{t("departments.error_title") || "Something went wrong"}</h1>
            <p className="text-foreground/70 mb-8">{t("departments.error_message") || "Could not load departments. Please try again later."}</p>
            <button
        ...
        <div className="relative bg-gradient-to-r from-blue-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border-b border-border overflow-hidden">
          ...
          <div className="container mx-auto px-4 py-10 md:py-14 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 backdrop-blur-sm rounded-full mb-3">
                <Building2 className="w-4 h-4 text-primary" />
                <span className="text-sm font-medium text-primary">{t("departments.badge") || "Medical Services"}</span>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            {departments.length === 0 ? (
              <div className="text-center py-16 bg-card border border-border rounded-2xl">
                <Stethoscope className="w-20 h-20 mx-auto mb-4 opacity-20 text-foreground" />
                <h3 className="text-xl font-semibold text-foreground mb-2">{t("departments.empty_title") || "No Departments Yet"}</h3>
                <p className="text-foreground/70">{t("departments.empty_message") || "Departments will appear here once added."}</p>
              </div>
            ) : (
              <>
                {/* Department count */}
                  ...
                  {departments.map((department) => {
                    ...
                    return (
                      <Link
                        ...
                        className="group bg-card border border-border hover:border-primary/50 rounded-2xl p-5 transition-all hover:shadow-lg hover:-translate-y-1"
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-2 text-primary text-xs font-medium">
