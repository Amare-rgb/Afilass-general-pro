  ...
  return (
    <>
      ...
      <div className="flex items-center justify-end mb-8 flex-wrap gap-4">
        ...
        <button
          onClick={startCreate}
          className="focus-ring rounded-lg bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 text-sm font-semibold px-5 py-2.5 transition-colors shadow-sm"
        >
          + Add Doctor
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {doctors.map((doc) => (
            <div key={doc.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-xl hover:border-blue-300 hover:scale-[1.02] transition-all duration-300 flex flex-col">
              <div className="relative flex-shrink-0 p-4 bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center">
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <p className="text-sm text-blue-600 font-medium text-center">{doc.specialization || doc.title}</p>
