// app/admin/doctors/afilas-general/page.tsx
'use client';
    ...
    <>
      <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Manage doctors for Afilas General Hospital</p>
          </div>
        </div>
        <button
          onClick={startCreate}
          className="focus-ring rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2.5 transition-colors flex items-center gap-2 shadow-sm"
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="focus-ring w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-blue-500 transition-colors"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="focus-ring w-full rounded-lg border border-gray-300 pl-10 pr-4 py-2.5 focus:border-blue-500 transition-colors"
                    />
                  </div>
                </div>
                <div>
                      ...
                      <div className="flex-1 grid grid-cols-2 gap-3">
                        <div>
                          <input
                            ...
                            className={`focus-ring w-full rounded-lg border px-3 py-1.5 text-sm focus:border-blue-500 transition-colors ${
      ...
      {loading ? (
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-12 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">No doctors available for Afilas General Hospital</p>
          <button
            onClick={startCreate}
            className="focus-ring rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2.5 transition-colors"
          >
            + Add Doctor
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {doctors.map((doc) => (
            <div key={doc.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 flex flex-col">
              <div className="relative h-56 bg-gradient-to-br from-blue-50 to-gray-100 flex-shrink-0">
                {doc.photoUrl ? (
                  <Image
                    src={doc.photoUrl}
                    alt={doc.name}
                  ...
                  <div className="flex items-center justify-center h-full">
                    <Hospital className="w-20 h-20 text-blue-300" />
                  </div>
                )}
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <p className="text-sm text-blue-600 font-medium">{doc.specialization || doc.title}</p>
      ...
      {!loading && doctors.length > 0 && (
        <div className="mt-4 text-xs text-gray-400 flex items-center justify-between">
          <span>Showing {doctors.length} doctor{doctors.length !== 1 ? 's' : ''} for Afilas General Hospital</span>
          <button
            onClick={() => load()}
