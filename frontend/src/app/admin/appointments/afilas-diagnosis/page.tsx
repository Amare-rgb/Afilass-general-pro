// app/admin/afilas-diagnosis/page.tsx
'use client';
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Manage appointments for Afilas Diagnosis Center
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        {loading ? (
          ...
          <div className="text-center p-12">
            ...
            <p className="text-sm text-gray-500">No appointments found for Afilas Diagnosis Center</p>
      ...
      {!loading && appointments.length > 0 && (
        <div className="text-xs text-gray-400">
          Showing {appointments.length} appointment{appointments.length !== 1 ? 's' : ''} for Afilas Diagnosis Center
        </div>
      )}
    </div>
  );
